 ...
 *
 * Revision 1.15  2017/09/29 07:40:37  Ken Lindsay
 * added Additional bit mask's

 * Revision 1.14  2007/07/02 07:40:37  sbormann714
...
#define DIRF_MASK         0x3f  /* Mask for DIRF    */
...
#define XOR_CHECK_RESULT  0xff

// Additional mask's, Ken Lindsay
#define MULTI_BYTE_MASK           0x60
#define SIX_BYTE_MASK             0x40
#define FOUR_BYTE_MASK            0x20
#define TWO_BYTE_MASK             0x00
#define OPC_BIT_SET               0x80
#define OPC_SIZE_MASK             0xe0
#define OPC_MULTI_BYTE_MASK       OPC_SIZE_MASK
#define OPC_SIX_BYTE_MASK         (OPC_BIT_SET | SIX_BYTE_MASK)
#define OPC_FOUR_BYTE_MASK        (OPC_BIT_SET | FOUR_BYTE_MASK)
#define OPC_TWO_BYTE_MASK         (OPC_BIT_SET | TWO_BYTE_MASK)

// Six byte OPC_SIX_BYTE_FUNC: <OPC>,<RANGE>,<SLOT>,<ID1>,<FUNCTION>,<CHK>
#define F1_BELL                 0
#define F2_HORN                 1
#define F3_FUNCTION             2
#define F4_DYNAMIC_BRAKE        3
#define F0_LIGHT                4
#define F5_NOT_USED             5
#define F6_NOT_USED             6
#define F8_MUTE                 8

// Definitions are for Tsunami2 Atherns Genesis F7, and ESU LokSound
#define F26_NOTCH_UP              26
#define F27_NOTCH_DOWN            27
#define OPC_SIX_BYTE_FUNC         0xd5
#define SIX_BYTE_SPD_REV          0x08
#define SIX_BYTE_SPD_FWD          0x00
#define SIX_BYTE_F0_F6            0x10
#define F0_LIGHT_MASK             0x10
#define F1_BELL_MASK              0x01
#define F2_HORN_MASK              0x02
#define F3_FUNCTION_MASK          0x04
#define F4_DYNAMIC_BRAKE_MASK     0x08
#define F5_LIGHTING_1_MASK        0x20
#define F6_LIGHTING_2_MASK        0x40
#define SIX_BYTE_F7_F13           0x18
#define F7_FUNCTION_MASK          0x01
#define F8_MUTE_MASK              0x02
#define F9_FUNCTION_MASK          0x04
#define F10_FUNCTION_MASK         0x08
#define F11_FUNCTION_MASK         0x10
#define F12_FUNCTION_MASK         0x20
#define F13_FUNCTION_MASK         0x40
#define SIX_BYTE_F14_F20          0x20
#define F14__FUNCTION_MASK        0x01
#define F15_FUNCTION_MASK         0x02
#define F16_FUNCTION_MASK         0x04
#define F17_FUNCTION_MASK         0x08
#define F18_FUNCTION_MASK         0x10
#define F19_FUNCTION_MASK         0x20
#define F20_FUNCTION_MASK         0x40
#define SIX_BYTE_F21_F27          0x28
#define F21_FUNCTION_MASK         0x01
#define F22_FUNCTION_MASK         0x02
#define F23_FUNCTION_MASK         0x04
#define F24_FUNCTION_MASK         0x08
#define F25_FUNCTION_MASK         0x10
#define F26_NOTCH_UP_MASK         0x20
#define F27_NOTCH_DOWN_MASK       0x40
#define SIX_BYTE_F28_XX           0x30
#define F28_NOT_USED_MASK         0x00

/* Immediate packet defintions (IMM) DigiTraxx */
#define IMM_REP_REPEAT            0x04 // REP, lower nibble repeat count of = 4
#define IMM_REP_SHORT_PKT_LENGTH  0x30 // REP, upper nibble of packet length = 3
#define IMM_REP_LONG_PKT_LENGTH   0x40 // REP, upper nibble of packet length = 3
#define IMM_REP_5_12_SHORT_LENGTH 0x20 // REP, upper nibble 5 to 12 short length = 2
#define IMM_REP_5_12_LONG_LENGTH  0x30 // REP, upper nibble 5 to 12 long length = 3
#define IMM_BYTE_COUNT            0x0b // Command byte count
#define IMM_ARG1_FIXED_VALUE      0x7f // Fixed value argument
#define IMM_DHI_SHORT             0x02 // DCC 1xx Command MS bit is in IM2
#define IMM_DHI_LONG              0x04 // Dcc 1xx Command MS bit is in IM3
#define IMM_DHI_IM3_SHIFT         2
#define IMM_DHI_IM4_SHIFT         3
#define IMM_DHI_IM5_SHIFT         4
// Functions 5 thru 18
#define IM2_DCC_CMD_5_8           0x30 // Derived Function Group 2 - "101S DDDD" where S = 1
// Functions 9 thru 12
#define IM2_DCC_CMD_9_12          0x20 // Derived Function Group 2 - "101S DDDD" where S = 0
// Functions 13 thru 20
#define IM2_DCC_CMD_13_20         0x5e // Derived from F13-F20 – Sub-instruction “110 11110”
// Functions 21 thru 28
#define IM2_DCC_CMD_21_28         0x5f // Derived from F21-F28 – Sub-instruction “110 11111”
...
#define OPC_SW_REQ_THRU      0x20  /* 'Closed' line is ON, OFF otherwise   */

#define OPC_SW_STATE_SW      0x20  /* switch input, aux input otherwise    */
#define OPC_SW_STATE_HI      0x10  /* input is HI, LO otherwise            */
#define OPC_SW_STATE_CLOSED  0x20  /* 'Closed' line is ON, OFF otherwise   */
#define OPC_SW_STATE_THROWN  0x00  /* 'Thrown' line is ON, OFF otherwise   */
...
typedef struct sendpkt_t {
    ...
    uint8_t im1;           /* long address lo or short address                     */
    uint8_t im2;           /* long address hi or fixed value of 0x5f for short     */
    uint8_t im3;           /* long address fixed value 0x5f or short function bits */
    uint8_t im4;           /* long address function bits or short fixed value of 0 */
    uint8_t im5;           /* long address and short address fixed value of 0      */
    uint8_t chksum;        /* exclusive-or checksum for the message                */
} sendPktMsg;
...
#define OPC_PANEL_RESPONSE 0xd7 // Undocumented name
#define OPC_PANEL_QUERY    0xdf // Undocumented name
#define OPC_LISSY_UPDATE   0xe4 // Undocumented name
#define OPC_PEER_XFER      0xe5
#define OPC_ALM_READ       0xe6 // Undocumented name
